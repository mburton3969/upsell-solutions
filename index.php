        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col" id="item_specifics">
                  <button type="button" id="add_specific" style="width: 32%;display:inline;" name="add_specific" class="form-control btn btn-primary" onclick="new_specific();"><i class="fas fa-plus"></i></button>
